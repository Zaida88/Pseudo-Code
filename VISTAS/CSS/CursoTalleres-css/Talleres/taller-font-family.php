...
<head>
    ...
    <title>Taller CSS - Font-family</title>
...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="container">
        <div class="contenedor">
            <h2 id="t"><b>TALLER CSS FONT-FAMILY</b></h2>
            <div class="contenido-taller">
                <div class="contenido">
                    <h3><b>FONT-FAMILY</b></h3>
                    <p>Por ejemplo si quisiera establecer a h2 la fuente de su elemento en sans-serif, usaría el siguiente CSS:
                        ...
                        <p class="imagen1"><b> &lt h2: A QUE NO PUEDES CAMBIARME DE LETRA &gt <br>
                            &ltstyle&gt<br>
                            h2{
                                font-family: sans-serif; }<br>
                            &lt/style&gt
                        </b>  
                        <center><p class="mensaje1"><b>En el ejemplo establecimos un <b>font-family: sans-serif</b>, el ejemplo que vas a realizar debes poner un parrafo &ltp&gt y implementar la fuente <b>pinky cupid</b>.<br>Puedes tomar como ejemplo el código de arriba.</b></p></center>
                    </p>  
                    </p>
                    <div class="codigo">
                        <textarea

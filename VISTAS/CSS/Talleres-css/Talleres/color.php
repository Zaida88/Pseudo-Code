...
<body>
    ...
    <div class="container">
        <div class="contenedor">
            <h2 id="t"><b>TALLER CSS COLOR</b></h2>
            <div class="contenido-taller">
                <div class="contenido">
                    <h3><b>COLOR</b></h3>
                    <p>Se utiliza para dar color a un elemento html ya sea el margen de una imagen o texto.
                        ...
                        <p class="imagen1"><b>.ejemplo1{ color: black; }</b>  
                        <center><p class="mensaje1"><b>En el ejemplo pusimos el texto en color <b>negro</b>, el ejemplo que vas a realizar le vas a colocar al texto en <b>azul (blue)</b>.<br>Puedes tomar como ejemplo el código de arriba.</b></p></center> 
                    </p>
                    <div class="codigo">
                        <textarea  id="txtCodigo"></textarea>
                    </div>
                    <button class="btn btn-primary" onclick="mostrar_texto.accion(ejemplo1)">Visualizar</button><br>
                </div>
                <div class="mostrar" id="mostrar"> 
                    <main>
                        <p id="ejemplo1">Ejemplo a realizar cambiar<br> a color azúl <b>(blue)</b></p>
                    </main>
                </div>

...
<head>
    ...
    <title>Taller CSS - Border-radius</title>
...
<body>
    ...
    <div class="container">
        <div class="contenedor">
            <h2 id="t"><b>TALLER CSS BORDER-RADIUS</b></h2>
            <div class="contenido-taller">
                <div class="contenido">
                    <h3><b>BORDER-RADIUS</b></h3>
                    <p>Por ejemplo si quisieramos crear un borde de 5 píxeles alrededor de un elemento, podríamos usar 
                        ...
                        <center><p class="mensaje1"><b>En el ejemplo pusimos un border de  <b>10px</b>, el ejemplo que vas a realizar le vas a colocar un borde de <b>100px</b>.<br>Puedes tomar como ejemplo el código de arriba.</b></p></center>
                    </p>  
                    </p>
                    <div class="codigo">
                        <textarea
    ...
    <script src="../../../../JS/CSS/border radius.js"></script>
</body>
</html>
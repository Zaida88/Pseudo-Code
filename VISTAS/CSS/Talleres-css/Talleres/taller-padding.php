<DOCTYPE html>
    ...
    <head>
        ...
        <title>Taller CSS - Padding</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="container">
            <div class="contenedor">
                <h2 id="t"><b>TALLER CSS PADDING</b></h2>
                <div class="contenido-taller">
                    <div class="contenido">
                        <h3><b>PADDING</b></h3>
                        <p>Por ejemplo el Padding es el espacio entre las cajas como por ejemplo si quiseramos darle un espacio a una imagen de su borde seria asi
                            ...
                            <center><p class="mensaje1"><b>En el ejemplo pusimos un padding de <b>100px</b>, el ejemplo que vas a realizar le vas a colocar un padding de <b>30px</b>.<br>Puedes tomar como ejemplo el código de arriba.</b></p></center>
                        </p>  
                        </p>
                        <div class="codigo">
                            <textarea
        ...
        <script src="../../../../JS/CSS/padding.js"></script>
    </body>
    </html>
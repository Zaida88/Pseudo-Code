...
<head>
    ...
    <title>Curso HTML - &ltfrom&gt</title>
...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="container">
        <div class="contenedor">
            <h2><b>CURSO HTML - &ltfrom&gt</b></h2>
            <div class="contenido-cursos">
                <p>
                    El elemento HTML form &ltfrom&gt representa una sección de un documento que contiene controles
                    interactivos que permiten a un usuario enviar información a un servidor web.
                </p>
                <img src="../../../IMG/from.png">
            </div>
        </div>
    </div>

...
<head>
    ...
    <title>Curso HTML - &lth1&gt</title>
    ...
    <div class="container">
        <div class="contenedor">
            <div class="navegacion">
                <div class="botones">
                    <h2><B>CURSO HTML - &lth1&gt</B></h2>
                    <a href="curso-h2.php"><button>►</button></a>
                </div>
            </div>
            <div class="contenido-cursos">
                <p>
                    El &lth1&gt es una etiqueta que se utiliza para identificar aquellas frases que conforman el título
                    principal de un contenido de una página web.
                    Particularmente, el &lth1&gt debe resumir en una frase todo lo que representa la página.
                </p>
                <img src="../../../IMG/h1.png">
            </div>
        </div>

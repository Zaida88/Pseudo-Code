...
<head>
    ...
    <title>Taller HTML - &lth1&gt</title>
...
<body>
    ...
    <div class="container">
        <div class="contenedor">
            <div class="navegacion">
                <div class="botones">
                    <h2 class="text-black"><b>TALLER HTML - &lth1&gt</b></h2>
                </div>
            </div>
            <div class="contenido-taller">
                <div class="contenido">
                   <h3>&lth1&gt</h3>
                    <p>A continuacion coloca un titulo para tu pagina. 
                        <br>(Es necesario usar espacios en el codigo)<br><br>
                        <strong>Ejemplo: </strong>
                        <h3 class="user-select-none">&lth1&gt Mi pagina web &lt/h1&gt</h3> <br>
                    <div class="codigo">
                ...
                <div class="mensaje" id="mensaje">
                    <p>Correcto</p>
                    <button><a href="taller-h2.php">Continuar</a></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="../../../JS/HTML/h1.Js"></script>
</body>
</html>
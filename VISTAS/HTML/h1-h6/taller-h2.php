...
<head>
    ...
    <title>Taller HTML - &lth2&gt</title>
...
<body>
    ...
    <div class="container">
        <div class="contenedor">
            <div class="navegacion">
                <div class="botones">
                    <h2>Taller HTML - &lth2&gt</h2>
                </div>
            </div>
            <div class="contenido-taller">
                <div class="contenido">
                    <h3>&lth2&gt</h3>
                    <p>A continuacion coloca un subtítulo para tu pagina <br> 
                        <b><u>Recuerda</u></b> <br>
                        Un título generalmente va seguido de un subtítulo, a continuacion coloca un subtítulo. 
                        <br><b>(Es necesario usar espacios en el codigo)</b><br><br>
                        <strong>Ejemplo: </strong>
                        <h2 class="user-select-none">&lth2&gt Mi subtítulo &lt/h2&gt</h2>
                    <div class="codigo">
                ...
                <div class="mensaje" id="mensaje">
                    <p>Correcto</p>
                    <button><a href="taller-h3.php">Continuar</a></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="../../../JS/HTML/h2.js"></script>
</body>
</html>
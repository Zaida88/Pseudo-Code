...
<head>
    ...
    <title>Taller HTML - &lth3&gt</title>
...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="container">
        <div class="contenedor">
            <div class="navegacion">
                <div class="botones">
                    <h2>Taller HTML - &lth3&gt</h2>
                </div>
            </div>
            <div class="contenido-taller">
                <div class="contenido">
                    <h3>&lth3&gt</h3>
                    <p>A continuacion coloca un subsecciones para tu pagina <br> 
                        <b><u>Recuerda</u></b> <br>
                        Luego de colocar el subtítulo podremos colocar subsecciones,<br> a continuacion coloca una subseccion. 
                        <br><b>(Es necesario usar espacios en el codigo)</b><br><br>
                        <strong>Ejemplo: </strong>
                          <h3 class="user-select-none">&lth3&gt Mis subsecciones &lt/h3&gt</h3><br>
                    <div class="codigo">
                ...
                <div class="mensaje" id="mensaje">
                    <p>Correcto</p>
                    <button><a href="taller-h4.php">Continuar</a></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="../../../JS/HTML/h3.js"></script>
</body>
</html>
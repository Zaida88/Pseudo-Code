...
<head>
    ...
    <title>Taller HTML - &lth5&gt</title>
...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="container">
        <div class="contenedor">
            <div class="navegacion">
                <div class="botones">
                    <h2>Taller HTML - &lth5&gt</h2>
                </div>
            </div>
            <div class="contenido-taller">
                <div class="contenido">
                    <h3>&lth5&gt</h3>
                    <p>A continuacion coloca un encabezado tamaño h5. <br> 
                        <br><b>(Es necesario usar espacios en el codigo)</b><br><br>
                        <strong>Ejemplo: </strong>
                        <h3 class="user-select-none">&lth5&gt Mi encabezado h5 &lt/h5&gt</h3>
                    <div class="codigo">
                ...
                <div class="mensaje" id="mensaje">
                    <p>Correcto</p>
                    <button><a href="taller-h6.php">Continuar</a></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="../../../JS/HTML/h5.js"></script>
</body>
</html>
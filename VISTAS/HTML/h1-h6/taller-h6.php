...
<head>
    ...
    <title>Taller HTML - &lth6&gt</title>
...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="container">
        <div class="contenedor">
            <div class="navegacion">
                <div class="botones">
                    <h2>Taller HTML - &lth6&gt</h2>
                </div>
            </div>
            <div class="contenido-taller">
                <div class="contenido">
                    <h3>&lth6&gt</h3>
                    <p>A continuacion coloca un encabezado tamaño h6. <br> 
                        <br><b>(Es necesario usar espacios en el codigo)</b><br><br>
                        <strong>Ejemplo: </strong>
                        <h3 class="user-select-none">&lth6&gt Mi encabezado h6 &lt/h6&gt</h3>
                    <div class="codigo">
                ...
                <div class="mensaje" id="mensaje">
                    <p>Correcto<br> felicidades por terminar<br> el taller h1 - h6</p>
    ...
    <script src="../../../JS/HTML/h6.js"></script>
</body>
</html>
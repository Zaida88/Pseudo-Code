...
<head>
    ...
    <title>Curso JS - Operadores de asignación</title>
...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="container">
        <div class="contenedor">
            <h2><b>CURSO JS - OPERADORES DE ASIGNACIÓN</b></h2>
            <div class="navegacion2">
                <div class="botones">
                    <h3 class="text-black">OPERADORES DE ASIGNACIÓN</h3>
                </div>
            </div>
            <div class="contenido-cursos">
                ...
                <p class="mensaje">Puede utilizar varios operadores de asignación en una línea, como x - = y + = 9.</p>
            </div>
        </div>
    </div>

    ...
    <div class="container">
        <div class="contenedor">
            ...
            <div class="navegacion2">
                <div class="botones">
                    <a href="curso-break_y_continue-break.php"><button>◄</button></a>
                    <h3>CONTINUE</h3>
                </div>
            </div>
            <div class="contenido-cursos">
                <p>
                    La instrucción continue rompe solo una iteración en el ciclo y continúa con la siguiente iteración.
                </p>
                <img src="../../../../../IMG/continue.png"><br>
                <strong>Resultado:</strong><br>
                <img src="../../../../../IMG/resultado_continue.png" alt="">
                <p class="mensaje">El valor 5 no se imprime, porque continue omite esa iteración del ciclo.
                </p>
            </div>
        </div>
    </div>

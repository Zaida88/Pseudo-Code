...
<head>
    ...
    <title>Taller JS - Concatenación</title>
...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="container">
        <div class="contenedor">
            <div class="navegacion">
                <div class="botones">
                    <h2><b>TALLER JS - CONCATENACIÓN</b></h2>
                </div>
            </div>
            <div class="contenido-taller">
                <div class="contenido">
                    <p>
                        La concatenación nos permite unir cadenas, numeros y variables.
                        A continuación ingrese datos para que sean concatenados. <br>
                        Recuerde usar el signo correcto.
                    </p>
                    <div class="codigo"><br>
                        <div class="ingreso" style="text-align: justify;">
                            var concatenacion = "
                            <input type="number" name="numero" id="numero" ><input type="text" id="signo1" placeholder="signo"><input type="text" id="cadena" ><input type="text" id="signo2" placeholder="signo"><input type="time" name="" id="hora"> " ;                                                       
                        </div><br>            
                    </div>
    ...
    <script src="../../../../../JS/JS/Conceptos basicos/concatenacion/concatenacion.js"></script>
</body>

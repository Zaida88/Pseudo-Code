...
<nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="contenedor">
            <div class="navegacion">
                <div class="botones">
                    ...
                    <a href="taller-tipos_de_datos-decimales.php"><button>►</button></a>
                </div>
            </div>
            <div class="contenido-taller">
                <div class="contenido">
                    <h3>CADENAS</h3><br>
                    <p>
                        Las cadenas se utilizan para representar datos textuales. <br>
                        A continuación ingrese la cadena que desee. <br>
                        <strong>Ejemplo: </strong>var variable = " Las rosas son rojas ";<br><br>
                    </p>
                    <div class="codigo">
    ...
    <script src="../../../../../JS/JS/Conceptos basicos/tipos de datos/cadenas.js"></script>
</body>

...
<head>
    ...
    <title>Taller JS - Asignar valores a variables</title>
...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="container">
        <div class="contenedor">
            <div class="navegacion">
                <div class="botones">
                    <a href="taller-variables-diferenciar_mayusculas_de_minusculas.php"><button>◄</button></a>
                    <h2><b>TALLER JS - VARIABLES</b></h2>
                </div>
            </div>
            <div class="contenido-taller">
                <div class="contenido">
                    <h3>ASIGNAR VALORES A VARIABLES</h3><br>
                    <p>
                        En JavaScript declaramos variables usando la palabra reservada "var". <br>
                        A continuación cree una variable llamada miVariable y asignele un valor.<br><br>
                        <strong>Ejemplo: </strong>var variable = 5 ;
                    </p>
                    <div class="codigo">
    ...
    <script src="../../../../../JS/JS/Conceptos basicos/variables/asignar_valores.js"></script>
</body>

...
<head>
  ...
  <title>Taller JS - Funciones</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark">
    <div class="container">
      <a class="navbar-brand" href="#">Pseudo Code</a>
  ...
  <div class="container">
    <div class="contenedor">
      <div id="caja">
        <h1><b>TALLER JS - MODULO DE FUNCIONES</b></h1>
        <div class="etiquetas">
          <a href="alerta-cuadro_dialogo-confirmacion/taller-alert.php"><button>Alert, Confirm, Prompt</button></a>
        </div>
      </div>
    </div>

...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="container">
        <div class="contenedor">
            <div id="caja">
                <h1><b>TALLER - JAVASCRIPT</b></h1>
                <h3 class="text-black"><b>MODULOS</b></h3>
                <div class="etiquetas">
                    <a href="Conceptos basicos/conceptos_basicos-opciones.php"><button>Conceptos basicos</button></a>
                    <a href=""><button>Condicionales y bucles</button></a>
